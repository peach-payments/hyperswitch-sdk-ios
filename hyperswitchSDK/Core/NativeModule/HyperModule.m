...
RCT_EXTERN_METHOD(exitWidget: (nonnull NSNumber *)reactTag :(NSString)rnMessage :(NSString)widgetType)
RCT_EXTERN_METHOD(updateWidgetHeight: (NSString)widgetType :(nonnull NSNumber *)height)
